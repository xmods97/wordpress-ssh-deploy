...
SERVER_MU_PLUGIN_SYNC_PATHS='wp-content/mu-plugins/example-loader'
SERVER_ALLOWED_DEPLOY_MODES='preflight,code,db,code-db,uploads,plugins,mu-plugins,full,components'
